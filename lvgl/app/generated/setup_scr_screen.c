...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_img_1, 200, 60);
    ...
    lv_obj_set_pos(ui->screen_img_4, 75, 120);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 75, 120);
    lv_obj_set_size(ui->screen_btn_1, 63, 69);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 345, 120);
    lv_obj_set_size(ui->screen_btn_2, 85, 71);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_4, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_6, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_date, "0");
    lv_label_set_long_mode(ui->screen_label_date, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_date, 0, 30);
    lv_obj_set_size(ui->screen_label_date, 60, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_label_date, &lv_font_SourceHanSerifSC_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_label_date, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_time, "0");
    lv_label_set_long_mode(ui->screen_label_time, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_time, 0, 0);
    lv_obj_set_size(ui->screen_label_time, 60, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_label_time, &lv_font_SourceHanSerifSC_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_label_time, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_label_time, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_spinbox_1, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_spinbox_1, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_CURSOR|LV_STATE_DEFAULT);
    ...
    lv_style_set_text_font(&style_screen_spinbox_1_extra_btns_main_default, &lv_font_SourceHanSerifSC_Regular_12);
    ...
    lv_obj_set_pos(ui->screen_cont_2, 0, 60);
    lv_obj_set_size(ui->screen_cont_2, 480, 212);
    ...
    lv_obj_set_style_border_color(ui->screen_cont_2, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_8, 218, 45);
    lv_obj_set_size(ui->screen_label_8, 150, 40);
    ...
    lv_obj_set_style_text_font(ui->screen_label_8, &lv_font_montserratMedium_50, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_9, 338, 50);
    lv_obj_set_size(ui->screen_label_9, 40, 40);
    ...
    lv_obj_set_style_text_font(ui->screen_label_9, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_width(ui->screen_label_9, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
        ...
        //Write codes screen_btn_suspend
    ui->screen_btn_suspend = lv_btn_create(ui->screen_cont_2);
    ui->screen_btn_suspend_label = lv_label_create(ui->screen_btn_suspend);
    lv_label_set_text(ui->screen_btn_suspend_label, "Paused");
    lv_label_set_long_mode(ui->screen_btn_suspend_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_suspend_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_suspend, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_suspend_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_suspend, 100, 120);
    lv_obj_set_size(ui->screen_btn_suspend, 85, 40);

    //Write style for screen_btn_suspend, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_suspend, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_suspend, lv_color_hex(paramBgColor), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btn_suspend, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btn_suspend, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btn_suspend, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_suspend, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btn_suspend, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btn_suspend, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_btn_suspend, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_btn_suspend, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

        //Write codes screen_btn_cancel
    ui->screen_btn_cancel = lv_btn_create(ui->screen_cont_2);
    ui->screen_btn_suspend_label = lv_label_create(ui->screen_btn_cancel);
    lv_label_set_text(ui->screen_btn_suspend_label, "Cancel");
    lv_label_set_long_mode(ui->screen_btn_suspend_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_suspend_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_cancel, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_suspend_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_cancel, 320, 120);
    lv_obj_set_size(ui->screen_btn_cancel, 85, 40);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_cancel, lv_color_hex(paramBgColor), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_cancel, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
