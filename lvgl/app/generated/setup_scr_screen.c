...
void setup_scr_screen(lv_ui *ui)
{
    ...
    ui->screen_label_logo = lv_label_create(ui->screen);
    lv_label_set_text(ui->screen_label_logo, "SIGMA");
    lv_label_set_long_mode(ui->screen_label_logo, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_logo, 183, 6);
    lv_obj_set_size(ui->screen_label_logo, 128, 30);

    //Write style for screen_label_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_logo, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_logo, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_logo, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_logo, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_label_logo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_1, 105, 80);
    lv_obj_set_size(ui->screen_label_1, 50, 30);
    ...
    lv_obj_set_pos(ui->screen_label_2, 225, 89);
    lv_obj_set_size(ui->screen_label_2, 70, 22);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_3, 325, 80);
    lv_obj_set_size(ui->screen_label_3, 50, 30);
    ...
    lv_obj_set_style_img_opa(ui->screen_img_8, 100, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_4, 105, 80);
    lv_obj_set_size(ui->screen_label_4, 50, 30);
    ...
    lv_obj_set_pos(ui->screen_label_6, 325, 80);
    lv_obj_set_size(ui->screen_label_6, 50, 30);
    ...
    lv_obj_add_flag(ui->screen_btn_11, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_add_flag(ui->screen_btn_12, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_add_flag(ui->screen_img_12, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_add_flag(ui->screen_btn_13, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_set_size(ui->screen_cont_1, 350, 50);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x94877f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_spinbox_1, 138, 3);
    ...
    lv_obj_set_style_border_color(ui->screen_spinbox_1, lv_color_hex(0x94877f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_spinbox_1, &lv_font_SourceHanSerifSC_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_spinbox_1, lv_color_hex(0x94877f), LV_PART_CURSOR|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_14_label, "确定");
    ...
    lv_obj_set_pos(ui->screen_btn_14, 268, 0);
    lv_obj_set_size(ui->screen_btn_14, 75, 40);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_14, lv_color_hex(0x94877f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_15_label, "取消");
    ...
    lv_obj_set_pos(ui->screen_btn_15, 0, 2);
    lv_obj_set_size(ui->screen_btn_15, 75, 40);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_15, lv_color_hex(0x94877f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_11, "s");
    lv_label_set_long_mode(ui->screen_label_11, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_11, 170, 80);
    lv_obj_set_size(ui->screen_label_11, 20, 15);
    ...
    lv_label_set_text(ui->screen_label_12, "s");
    lv_label_set_long_mode(ui->screen_label_12, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_12, 390, 80);
    lv_obj_set_size(ui->screen_label_12, 20, 15);
    ...
    lv_label_set_text(ui->screen_label_9, "g");
    lv_label_set_long_mode(ui->screen_label_9, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_9, 170, 80);
    lv_obj_set_size(ui->screen_label_9, 20, 15);
    ...
    lv_label_set_text(ui->screen_label_10, "g");
    lv_label_set_long_mode(ui->screen_label_10, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_10, 390, 80);
    lv_obj_set_size(ui->screen_label_10, 20, 15);
    ...
    lv_obj_set_style_border_color(ui->screen_cont_2, lv_color_hex(0xff6500), LV_PART_MAIN|LV_STATE_DEFAULT);
