...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_3, &_shuangfen_alpha_100x108);
    lv_img_set_pivot(ui->screen_img_3, 50,50);
    lv_img_set_angle(ui->screen_img_3, 0);
    lv_obj_set_pos(ui->screen_img_3, 300, 84);
    lv_obj_set_size(ui->screen_img_3, 100, 108);
    ...
    lv_img_set_src(ui->screen_img_4, &_danfen_alpha_100x108);
    lv_img_set_pivot(ui->screen_img_4, 50,50);
    lv_img_set_angle(ui->screen_img_4, 0);
    lv_obj_set_pos(ui->screen_img_4, 80, 84);
    lv_obj_set_size(ui->screen_img_4, 100, 108);
    ...
    lv_obj_set_pos(ui->screen_img_9, 110, 219);
    ...
    lv_obj_set_pos(ui->screen_label_11, 160, 80);
    ...
    lv_obj_set_pos(ui->screen_label_12, 380, 80);
    ...
    lv_obj_set_pos(ui->screen_label_9, 160, 80);
    ...
    lv_obj_set_pos(ui->screen_label_10, 380, 80);
    ...
    lv_obj_set_pos(ui->screen_label_8, 190, 56);
