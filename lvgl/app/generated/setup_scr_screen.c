...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_1, &_11_alpha_20x20);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 154, 13);
    ...
    lv_label_set_text(ui->screen_label_1, "96.1");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 111, 15);
    lv_obj_set_size(ui->screen_label_1, 33, 13);
    ...
    lv_obj_set_style_text_opa(ui->screen_label_1, 248, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->screen_img_3, &_9_alpha_20x20);
    lv_img_set_pivot(ui->screen_img_3, 50,50);
    lv_img_set_angle(ui->screen_img_3, 0);
    lv_obj_set_pos(ui->screen_img_3, 12, 13);
    ...
    lv_label_set_text(ui->screen_label_3, "125.1");
    lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_3, 40, 15);
    lv_obj_set_size(ui->screen_label_3, 33, 13);
    ...
    lv_img_set_src(ui->screen_img_4, &_10_alpha_20x20);
    lv_img_set_pivot(ui->screen_img_4, 50,50);
    lv_img_set_angle(ui->screen_img_4, 0);
    lv_obj_set_pos(ui->screen_img_4, 84, 13);
    ...
    lv_label_set_text(ui->screen_label_4, "96.1");
    lv_label_set_long_mode(ui->screen_label_4, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_4, 111, 15);
    lv_obj_set_size(ui->screen_label_4, 33, 13);
    ...
    lv_img_set_src(ui->screen_img_5, &_E300UI216_alpha_30x30);
    lv_img_set_pivot(ui->screen_img_5, 50,50);
    lv_img_set_angle(ui->screen_img_5, 0);
    lv_obj_set_pos(ui->screen_img_5, 432, 17);
    lv_obj_set_size(ui->screen_img_5, 30, 30);
    ...
    lv_img_set_src(ui->screen_img_10, &_btnnew_alpha_130x90);
    lv_img_set_pivot(ui->screen_img_10, 50,50);
    lv_img_set_angle(ui->screen_img_10, 0);
    lv_obj_set_pos(ui->screen_img_10, 33, 85);
    lv_obj_set_size(ui->screen_img_10, 130, 90);
    ...
    lv_img_set_src(ui->screen_img_11, &_btnnew_alpha_130x90);
    lv_img_set_pivot(ui->screen_img_11, 50,50);
    lv_img_set_angle(ui->screen_img_11, 0);
    lv_obj_set_pos(ui->screen_img_11, 175, 85);
    lv_obj_set_size(ui->screen_img_11, 130, 90);
    ...
    lv_img_set_src(ui->screen_img_15, &_btnnew_alpha_130x90);
    lv_img_set_pivot(ui->screen_img_15, 50,50);
    lv_img_set_angle(ui->screen_img_15, 0);
    lv_obj_set_pos(ui->screen_img_15, 318, 85);
    lv_obj_set_size(ui->screen_img_15, 130, 90);
    ...
    lv_obj_set_style_text_font(ui->screen_label_21, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_22, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_23, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_24, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_25, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_26, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_cancel, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_menu, 432, 17);
    lv_obj_set_size(ui->screen_btn_menu, 30, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_menu, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_btnm_choosemode, &lv_font_montserratMedium_16, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_coffee1, 33, 85);
    lv_obj_set_size(ui->screen_btn_coffee1, 130, 90);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_coffee1, lv_color_hex(0xd79442), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btn_coffee1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_coffee3, 175, 85);
    lv_obj_set_size(ui->screen_btn_coffee3, 130, 90);
    ...
    lv_obj_set_pos(ui->screen_btn_coffee2, 318, 85);
    lv_obj_set_size(ui->screen_btn_coffee2, 130, 90);
...
// #if (LEFT_OR_COFFEE == LEFT)
    ...
    lv_img_set_src(ui->screen_img_hotwater, &_7_alpha_30x37);
...
// #if (LEFT_OR_COFFEE == LEFT)
   //Write codes screen_btn_hotwater
    ...
    lv_obj_set_size(ui->screen_btn_hotwater, 87, 47);
    ...
    lv_obj_set_style_text_color(ui->screen_btn_hotwater, lv_color_hex(0xfd9f45), LV_PART_MAIN|LV_STATE_DEFAULT);
...
// #endif
    ...
    lv_obj_set_pos(ui->screen_cont_teaset, 85, 28);
    lv_obj_set_size(ui->screen_cont_teaset, 331, 231);
    ...
    lv_obj_set_pos(ui->screen_btn_save, 240, 63);
    ...
    lv_obj_set_pos(ui->screen_btn_teacancel, 240, 133);
    ...
    lv_obj_set_pos(ui->screen_cont_countdown, 32, 80);
    lv_obj_set_size(ui->screen_cont_countdown, 420, 120);
    ...
    lv_obj_set_pos(ui->screen_label_16, 170, 74);
    lv_obj_set_size(ui->screen_label_16, 80, 20);
    ...
    lv_obj_set_style_text_color(ui->screen_label_16, lv_color_hex(0x3f291d), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_label_steamtime
    ui->screen_label_steamtime = lv_label_create(ui->screen);
    lv_label_set_text(ui->screen_label_steamtime, "0");
    lv_label_set_long_mode(ui->screen_label_steamtime, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_steamtime, 61, 181);
    lv_obj_set_size(ui->screen_label_steamtime, 76, 25);
    lv_obj_add_flag(ui->screen_label_steamtime, LV_OBJ_FLAG_HIDDEN);

    //Write style for screen_label_steamtime, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_steamtime, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_steamtime, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_steamtime, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_steamtime, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_steamtime, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_label_steamtime, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_cont_maintain, lv_color_hex(0xd6cdcd), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_label_maintain, "");
    ...
    lv_label_set_text(ui->screen_1_btn_maintain_label, "OK");
    ...
    //Write codes screen_cont_target
    ui->screen_cont_target = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_cont_target, 132, 37);
    lv_obj_set_size(ui->screen_cont_target, 216, 38);
    lv_obj_set_scrollbar_mode(ui->screen_cont_target, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->screen_cont_target, LV_OBJ_FLAG_HIDDEN);

    //Write style for screen_cont_target, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_target, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_target, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_cont_target, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_cont_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_btn_targetsave
    ui->screen_btn_targetsave = lv_btn_create(ui->screen_cont_target);
    ui->screen_btn_targetsave_label = lv_label_create(ui->screen_btn_targetsave);
    lv_label_set_text(ui->screen_btn_targetsave_label, "save");
    lv_label_set_long_mode(ui->screen_btn_targetsave_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_targetsave_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_targetsave, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_targetsave_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_targetsave, 160, 0);
    lv_obj_set_size(ui->screen_btn_targetsave, 56, 38);

    //Write style for screen_btn_targetsave, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_targetsave, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_targetsave, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btn_targetsave, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btn_targetsave, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btn_targetsave, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_targetsave, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btn_targetsave, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btn_targetsave, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_btn_targetsave, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_btn_targetsave, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_btnm_target
    ui->screen_btnm_target = lv_btnmatrix_create(ui->screen_cont_target);
    static const char *screen_btnm_target_text_map[] = {"S", "ML", "",};
    lv_btnmatrix_set_map(ui->screen_btnm_target, screen_btnm_target_text_map);
    lv_obj_set_pos(ui->screen_btnm_target, 0, 0);
    lv_obj_set_size(ui->screen_btnm_target, 160, 38);

    //Write style for screen_btnm_target, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btnm_target, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btnm_target, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btnm_target, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btnm_target, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btnm_target, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_btnm_target, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_btnm_target, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_btnm_target, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_btnm_target, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui->screen_btnm_target, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(ui->screen_btnm_target, 8, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_btnm_target, Part: LV_PART_ITEMS, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btnm_target, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btnm_target, lv_color_hex(0x2195f6), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btnm_target, LV_GRAD_DIR_NONE, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btnm_target, 1, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_btnm_target, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_btnm_target, lv_color_hex(0xc9c9c9), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_btnm_target, LV_BORDER_SIDE_FULL, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btnm_target, 4, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btnm_target, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btnm_target, lv_color_hex(0xffffff), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btnm_target, &lv_font_montserratMedium_16, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_btnm_target, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);

    //Write codes screen_cont_menupassword
    ui->screen_cont_menupassword = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_cont_menupassword, 0, 0);
    lv_obj_set_size(ui->screen_cont_menupassword, 480, 272);
    lv_obj_set_scrollbar_mode(ui->screen_cont_menupassword, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->screen_cont_menupassword, LV_OBJ_FLAG_HIDDEN);

    //Write style for screen_cont_menupassword, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_menupassword, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_menupassword, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_cont_menupassword, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_cont_menupassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_label_password
    ui->screen_label_password = lv_label_create(ui->screen_cont_menupassword);
    lv_label_set_text(ui->screen_label_password, "Enter Password");
    lv_label_set_long_mode(ui->screen_label_password, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_password, 180, 58);
    lv_obj_set_size(ui->screen_label_password, 155, 32);

    //Write style for screen_label_password, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_password, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_password, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_password, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_password, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_label_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_ta_password
    ui->screen_ta_password = lv_textarea_create(ui->screen_cont_menupassword);
    lv_textarea_set_text(ui->screen_ta_password, "");
    lv_textarea_set_placeholder_text(ui->screen_ta_password, "");
    lv_textarea_set_password_bullet(ui->screen_ta_password, "*");
    lv_textarea_set_password_mode(ui->screen_ta_password, false);
    lv_textarea_set_one_line(ui->screen_ta_password, false);
    lv_textarea_set_accepted_chars(ui->screen_ta_password, "");
    lv_textarea_set_max_length(ui->screen_ta_password, 4);
#if LV_USE_KEYBOARD != 0 || LV_USE_ZH_KEYBOARD != 0
    lv_obj_add_event_cb(ui->screen_ta_password, ta_event_cb, LV_EVENT_ALL, ui->g_kb_top_layer);
#endif
    lv_obj_set_pos(ui->screen_ta_password, 180, 100);
    lv_obj_set_size(ui->screen_ta_password, 120, 35);

    //Write style for screen_ta_password, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_text_color(ui->screen_ta_password, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_ta_password, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_ta_password, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_ta_password, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_ta_password, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_ta_password, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_ta_password, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_ta_password, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_ta_password, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_ta_password, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_ta_password, lv_color_hex(0xe6e6e6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_ta_password, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_ta_password, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_ta_password, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_ta_password, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_ta_password, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_ta_password, 4, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_ta_password, Part: LV_PART_SCROLLBAR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_ta_password, 255, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_ta_password, lv_color_hex(0x2195f6), LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_ta_password, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_ta_password, 0, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);

    //Write codes screen_label_passworderror
    ui->screen_label_passworderror = lv_label_create(ui->screen_cont_menupassword);
    lv_label_set_text(ui->screen_label_passworderror, "");
    lv_label_set_long_mode(ui->screen_label_passworderror, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_passworderror, 180, 153);
    lv_obj_set_size(ui->screen_label_passworderror, 153, 32);

    //Write style for screen_label_passworderror, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_passworderror, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_passworderror, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_passworderror, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_passworderror, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_label_passworderror, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_btn_passwordenter
    ui->screen_btn_passwordenter = lv_btn_create(ui->screen_cont_menupassword);
    ui->screen_btn_passwordenter_label = lv_label_create(ui->screen_btn_passwordenter);
    lv_label_set_text(ui->screen_btn_passwordenter_label, "OK");
    lv_label_set_long_mode(ui->screen_btn_passwordenter_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_passwordenter_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_passwordenter, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_passwordenter_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_passwordenter, 315, 100);
    lv_obj_set_size(ui->screen_btn_passwordenter, 100, 35);

    //Write style for screen_btn_passwordenter, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_passwordenter, 69, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_passwordenter, lv_color_hex(0xdaf2f8), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btn_passwordenter, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btn_passwordenter, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btn_passwordenter, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_passwordenter, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btn_passwordenter, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_btn_passwordback
    ui->screen_btn_passwordback = lv_btn_create(ui->screen_cont_menupassword);
    ui->screen_btn_passwordback_label = lv_label_create(ui->screen_btn_passwordback);
    lv_label_set_text(ui->screen_btn_passwordback_label, "BACK");
    lv_label_set_long_mode(ui->screen_btn_passwordback_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_passwordback_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_passwordback, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_passwordback_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_passwordback, 62, 102);
    lv_obj_set_size(ui->screen_btn_passwordback, 100, 35);

    //Write style for screen_btn_passwordback, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_passwordback, 67, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_passwordback, lv_color_hex(0xdaf2f8), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_btn_passwordback, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_btn_passwordback, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_btn_passwordback, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_passwordback, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btn_passwordback, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btn_passwordback, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_btn_passwordback, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_btn_passwordback, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    /* 高亮态（被选中） */
    lv_obj_set_style_bg_color(ui->screen_btnm_target,lv_color_hex(0xfd9f45),LV_PART_ITEMS | LV_STATE_CHECKED);// 高亮蓝
    lv_obj_set_style_text_color(ui->screen_btnm_target,lv_color_hex(0xFFFFFF),LV_PART_ITEMS | LV_STATE_CHECKED);
    /* 未选中态（灰） */
    lv_obj_set_style_bg_color(ui->screen_btnm_target,lv_color_hex(0xC9C9C9),LV_PART_ITEMS | LV_STATE_DEFAULT);// 灰色
    lv_obj_set_style_text_color(ui->screen_btnm_target,lv_color_hex(0x333333),LV_PART_ITEMS | LV_STATE_DEFAULT);// 深灰字
    ...
    lv_btnmatrix_set_btn_ctrl_all(ui->screen_btnm_target, LV_BTNMATRIX_CTRL_CHECKABLE);
    lv_btnmatrix_set_one_checked(ui->screen_btnm_target, true);
    lv_btnmatrix_set_btn_ctrl(ui->screen_btnm_target, 0, LV_BTNMATRIX_CTRL_CHECKED); /* 默认s高亮 */
    ...
    lv_label_set_text_fmt(guider_ui.screen_label_19, "%s", string_data1);
    lv_label_set_text_fmt(guider_ui.screen_label_10, "%s", string_data2);
