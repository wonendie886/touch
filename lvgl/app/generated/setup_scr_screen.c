...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_7, 0, 90);
    ...
    lv_obj_set_pos(ui->screen_label_8, 190, 114);
    ...
    lv_label_set_text(ui->screen_label_9, "Label");
    lv_label_set_long_mode(ui->screen_label_9, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_9, 380, 90);
    ...
    lv_label_set_text(ui->screen_btn_10_label, "cu");
    ...
    lv_obj_set_style_text_font(ui->screen_btn_10, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_11_label, "xi");
    ...
    lv_obj_set_pos(ui->screen_btn_11, 21, 155);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_11, lv_color_hex(0x009ea9), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->screen_btn_11, 25, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_11, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui->screen_btn_11, lv_color_hex(0x0d4b3b), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->screen_btn_11, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui->screen_btn_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_x(ui->screen_btn_11, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui->screen_btn_11, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_btn_11, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btn_11, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
