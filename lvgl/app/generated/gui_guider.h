...
typedef struct
{
	...
	lv_obj_t *screen_1_btn_grindsize;
	lv_obj_t *screen_1_btn_grindsize_label;
	lv_obj_t *screen_1_cont_1;
	lv_obj_t *screen_1_spinbox_grindsize;
	lv_obj_t *screen_1_spinbox_grindsize_btn_plus;
	lv_obj_t *screen_1_spinbox_grindsize_btn_minus;
	...
	lv_obj_t *screen_1_label_calibration2;
