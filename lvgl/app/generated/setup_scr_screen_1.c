...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0x845e5e), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_table_set_cell_value(ui->screen_1_table_1,0,0,"Time");
    lv_table_set_cell_value(ui->screen_1_table_1,1,0,"today");
    lv_table_set_cell_value(ui->screen_1_table_1,2,0,"a week");
    lv_table_set_cell_value(ui->screen_1_table_1,3,0,"all");
    lv_table_set_cell_value(ui->screen_1_table_1,0,1,"quantity");
    lv_table_set_cell_value(ui->screen_1_table_1,1,1,"***");
    lv_table_set_cell_value(ui->screen_1_table_1,2,1,"***");
    lv_table_set_cell_value(ui->screen_1_table_1,3,1,"***");
    lv_obj_set_pos(ui->screen_1_table_1, 108, 25);
    ...
    lv_obj_set_style_pad_top(ui->screen_1_table_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_1_table_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_table_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_table_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_1_table_1, 182, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_1_table_1, lv_color_hex(0x000e39), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_1_table_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_1_table_1, 21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_1_table_1, lv_color_hex(0x293333), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_table_1, &lv_font_Acme_Regular_20, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_width(ui->screen_1_table_1, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "BACK");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 1, 223);
    ...
    lv_obj_set_style_border_color(ui->screen_1_btn_1, lv_color_hex(0x5482a9), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_1_btn_1, lv_color_hex(0x12548b), LV_PART_MAIN|LV_STATE_DEFAULT);
