...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    ui->screen_1_menu_1_sidebar_page = lv_menu_page_create(ui->screen_1_menu_1, "Menu");
    lv_menu_set_sidebar_page(ui->screen_1_menu_1, ui->screen_1_menu_1_sidebar_page);
    lv_obj_set_scrollbar_mode(ui->screen_1_menu_1_sidebar_page, LV_SCROLLBAR_MODE_AUTO);
    ...
    lv_label_set_text(ui->screen_1_menu_1_label_1, "Settings");
    ...
    lv_label_set_text(ui->screen_1_menu_1_label_2, "Maintain");
    lv_obj_set_size(ui->screen_1_menu_1_label_2, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_1_menu_1_subpage_2, LV_SCROLLBAR_MODE_AUTO);
    ...
    lv_label_set_text(ui->screen_1_menu_1_label_3, "Password Settings");
    lv_obj_set_size(ui->screen_1_menu_1_label_3, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_1_menu_1_subpage_3, LV_SCROLLBAR_MODE_AUTO);
    lv_menu_set_load_page_event(ui->screen_1_menu_1, ui->screen_1_menu_1_cont_3, ui->screen_1_menu_1_subpage_3);

    //Create subpage for screen_1_menu_1
    ui->screen_1_menu_1_subpage_4 = lv_menu_page_create(ui->screen_1_menu_1, NULL);
    ui->screen_1_menu_1_cont_4 = lv_menu_cont_create(ui->screen_1_menu_1_sidebar_page);
    ui->screen_1_menu_1_label_4 = lv_label_create(ui->screen_1_menu_1_cont_4);
    lv_label_set_text(ui->screen_1_menu_1_label_4, "Coffee Boiler(T)");
    lv_obj_set_size(ui->screen_1_menu_1_label_4, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_1_menu_1_subpage_4, LV_SCROLLBAR_MODE_AUTO);
    lv_menu_set_load_page_event(ui->screen_1_menu_1, ui->screen_1_menu_1_cont_4, ui->screen_1_menu_1_subpage_4);
    ...
    lv_style_set_bg_opa(&style_screen_1_menu_1_extra_sidebar_page_main_default, 71);
    ...
    lv_obj_add_style(ui->screen_1_menu_1_cont_4, &style_screen_1_menu_1_extra_option_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->screen_1_menu_1_cont_4, &style_screen_1_menu_1_extra_option_btns_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_style_set_text_font(&style_screen_1_menu_1_extra_main_title_main_default, &lv_font_montserratMedium_16);
    ...
    lv_style_set_bg_opa(&style_screen_1_menu_1_extra_main_title_main_default, 0);
    ...
    //Write codes screen_1_label_coffeeboilerT
    ui->screen_1_label_coffeeboilerT = lv_label_create(ui->screen_1_menu_1_subpage_4);
    lv_label_set_text(ui->screen_1_label_coffeeboilerT, "0");
    lv_label_set_long_mode(ui->screen_1_label_coffeeboilerT, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_coffeeboilerT, 190, 120);
    lv_obj_set_size(ui->screen_1_label_coffeeboilerT, 170, 184);

    //Write style for screen_1_label_coffeeboilerT, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_label_coffeeboilerT, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_label_coffeeboilerT, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_1_label_coffeeboilerT, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_1_label_coffeeboilerT, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_1_label_coffeeboilerT, 85, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_1_label_coffeeboilerT, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_descale, 98, 44);
    lv_obj_set_size(ui->screen_1_btn_descale, 130, 50);
    ...
    lv_obj_set_style_border_width(ui->screen_1_btn_descale, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_descale, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_label_2, 190, 120);
    ...
    lv_label_set_text(ui->screen_1_btn_changewater_label, "Change Boiler Water");
    ...
    lv_obj_set_pos(ui->screen_1_btn_changewater, 82, 100);
    lv_obj_set_size(ui->screen_1_btn_changewater, 130, 50);
    ...
    lv_obj_set_style_border_width(ui->screen_1_btn_changewater, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_changewater, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_emptywater_label, "Water Draining");
    ...
    lv_obj_set_pos(ui->screen_1_btn_emptywater, 73, 64);
    lv_obj_set_size(ui->screen_1_btn_emptywater, 130, 50);
    ...
    lv_obj_set_style_border_width(ui->screen_1_btn_emptywater, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_emptywater, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_label_3 = lv_label_create(ui->screen_1_menu_1_subpage_2);
    lv_label_set_text(ui->screen_1_label_3, "Label");
    lv_label_set_long_mode(ui->screen_1_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_3, 192, 151);
    lv_obj_set_size(ui->screen_1_label_3, 100, 10);
    ...
    //Write codes screen_1_btn_backflush
    ui->screen_1_btn_backflush = lv_btn_create(ui->screen_1_menu_1_subpage_2);
    ui->screen_1_btn_backflush_label = lv_label_create(ui->screen_1_btn_backflush);
    lv_label_set_text(ui->screen_1_btn_backflush_label, "Brew Head Backflush");
    lv_label_set_long_mode(ui->screen_1_btn_backflush_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_1_btn_backflush_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_1_btn_backflush, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_1_btn_backflush_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_1_btn_backflush, 128, 146);
    lv_obj_set_size(ui->screen_1_btn_backflush, 130, 50);

    //Write style for screen_1_btn_backflush, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_1_btn_backflush, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_btn_backflush, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_1_btn_backflush, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_1_btn_backflush, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_1_btn_backflush, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_1_btn_backflush, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_1_btn_backflush, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_btn_backflush, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_btn_backflush, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_1_btn_backflush, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_1_btn_backflush, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_back, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write style for screen_1_btn_maintainon, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_size(ui->screen_1_btn_brewblock, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_brewblock, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_brewblock, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_hotwaterset, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_hotwater, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->screen_1_btn_steamtempset, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_steamtempset, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_steamtemp, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->screen_1_btn_coffeetempset, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_coffeetempset, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_coffeetemp, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_btn_steamset = lv_btn_create(ui->screen_1_cont_setting);
    ...
    lv_obj_set_pos(ui->screen_1_btn_steamset, 150, 114);
    lv_obj_set_size(ui->screen_1_btn_steamset, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_steamset, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_label_steam = lv_label_create(ui->screen_1_cont_setting);
    lv_label_set_text(ui->screen_1_label_steam, "Steam(s)");
    lv_label_set_long_mode(ui->screen_1_label_steam, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_steam, 20, 114);
    lv_obj_set_size(ui->screen_1_label_steam, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_steam, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_1_label_steam, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->screen_1_btn_time3set, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_time3set, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_time3, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_time2set, 150, 228);
    lv_obj_set_size(ui->screen_1_btn_time2set, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_time2set, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_time2, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_time1set, 150, 152);
    lv_obj_set_size(ui->screen_1_btn_time1set, 100, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_time1set, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_time1, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_cancel, 5, 7);
    lv_obj_set_size(ui->screen_1_btn_cancel, 50, 40);
    ...
    lv_label_set_text(ui->screen_1_btn_certain_label, "Certain");
    ...
    lv_obj_set_pos(ui->screen_1_btn_certain, 245, 7);
    lv_obj_set_size(ui->screen_1_btn_certain, 50, 40);
    ...
    lv_obj_set_pos(ui->screen_1_spinbox_1, 115, 2);
    lv_obj_set_width(ui->screen_1_spinbox_1, 70);
    lv_obj_set_height(ui->screen_1_spinbox_1, 50);
    lv_spinbox_set_digit_format(ui->screen_1_spinbox_1, 3, 3);
    lv_spinbox_set_range(ui->screen_1_spinbox_1, 0, 999);
    ...
    lv_obj_set_style_pad_top(ui->screen_1_spinbox_1, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_1_spinbox_1, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_1_spinbox_1, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_1_spinbox_1, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_spinbox_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_spinbox_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_spinbox_1, &lv_font_montserratMedium_16, LV_PART_CURSOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_cont_passwordset, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_cont_passwordset, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_1_cont_passwordset, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_passwordsave_label, "Save");
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_passwordsave, 69, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_passwordsave, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_label_savesuccess, 59, 65);
    lv_obj_set_size(ui->screen_1_label_savesuccess, 145, 32);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_savesuccess, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui->screen_1_label_time1,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_label_time2,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_label_time3,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_label_steam,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_btn_time1set,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_btn_time2set,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_btn_time3set,LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_1_btn_steamset,LV_OBJ_FLAG_HIDDEN);
