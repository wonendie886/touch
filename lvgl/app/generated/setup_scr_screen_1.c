...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "thick");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 287, 101);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_1, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_2_label, "thin");
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 139, 101);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_2, &lv_font_SourceHanSerifSC_Regular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_3, 379, 219);
