...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_menu, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_label_set, "125");
    lv_label_set_long_mode(ui->screen_1_label_set, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_set, 95, 24);
    lv_obj_set_size(ui->screen_1_label_set, 90, 40);

    //Write style for screen_1_label_set, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_1_label_set, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->screen_1_label_set, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_label_set, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_label_set, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_set, 95, 24);
    lv_obj_set_size(ui->screen_1_btn_set, 90, 40);
    ...
    lv_label_set_text(ui->screen_1_btn_settime1_label, "030");
    ...
    lv_obj_set_pos(ui->screen_1_btn_settime1, -12, 77);
    lv_obj_set_size(ui->screen_1_btn_settime1, 100, 50);

    //Write style for screen_1_btn_settime1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_1_btn_settime1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_btn_settime1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_1_btn_settime1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_btn_settime1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_settime2_label, "045");
    ...
    lv_obj_set_pos(ui->screen_1_btn_settime2, -11, 140);
    lv_obj_set_size(ui->screen_1_btn_settime2, 100, 50);

    //Write style for screen_1_btn_settime2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_1_btn_settime2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_btn_settime2, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_1_btn_settime2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_btn_settime2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_settime3_label, "060");
    ...
    lv_obj_set_pos(ui->screen_1_btn_settime3, -11, 201);
    lv_obj_set_size(ui->screen_1_btn_settime3, 100, 50);

    //Write style for screen_1_btn_settime3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_1_btn_settime3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_btn_settime3, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_1_btn_settime3, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_btn_settime3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_cont_set, -9, 89);
    lv_obj_set_size(ui->screen_1_cont_set, 289, 47);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_cont_set, lv_color_hex(0x868686), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_spinbox_set, 110, 3);
    lv_obj_set_width(ui->screen_1_spinbox_set, 70);
    lv_obj_set_height(ui->screen_1_spinbox_set, 39);
    lv_spinbox_set_digit_format(ui->screen_1_spinbox_set, 3, 3);
    lv_spinbox_set_range(ui->screen_1_spinbox_set, 0, 135);
    ...
    lv_obj_set_pos(ui->screen_1_btn_certain, 228, 1);
    lv_obj_set_size(ui->screen_1_btn_certain, 59, 44);
    ...
    lv_obj_set_pos(ui->screen_1_btn_cancel, 2, 2);
    lv_obj_set_size(ui->screen_1_btn_cancel, 61, 41);
