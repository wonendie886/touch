...
u8 TP_Init(void)
{
	...
	if(lcddev.id==0X5510||lcddev.id==0X9806)				//4.3����ݴ�����
	{
    GT1151_Init();			
	...
	else if(lcddev.id==0X7796||lcddev.id==0X5310)    //3.5����ݴ�����
	{
...
//	 else
//	 {
//		 if(RTP_Init()==0)      //�Ե��败�������г�ʼ��      
// 		   return 0; 
//		 else 
//			 return 1;
//	 }	 
	}
	else if(lcddev.id==0X7789)    //3.5����ݴ�����
	{
	 GT1151_Init();         //�ж��ǵ��ݴ��������ǵ��败����
	 tp_dev.scan=GT1151_Scan;    //ɨ�躯��ָ��GT1151������ɨ��
		tp_dev.touchtype|=0X80;     //������ 
		tp_dev.touchtype|=lcddev.dir&0X01;//������������
		return 0;
	...
	else
	{
		...
		//PB12,13��ʼ������
		GPIO_Initure.Pin=GPIO_PIN_12|GPIO_PIN_13;	//PB12/PB13 ����Ϊ��������
		GPIO_Initure.Mode=GPIO_MODE_INPUT;  	  //����ģʽ
		GPIO_Initure.Pull=GPIO_PULLUP;          //����
		GPIO_Initure.Speed=GPIO_SPEED_HIGH;     //����
		HAL_GPIO_Init(GPIOB,&GPIO_Initure);     //��ʼ��
		...
		//PB14
		GPIO_Initure.Pin=GPIO_PIN_14;          	//PB14����Ϊ�������
		HAL_GPIO_Init(GPIOB,&GPIO_Initure);     //��ʼ��
